...
@section('title', __('Sended Request'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('user.home.index') }}"><i class="fas fa-home"></i></a></li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('Sended Requests') }}</li>
@endsection
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header pb-1">
                            <h4>
                                <div class="btn-group">
                                    <a class="btn {{ Route::is('user.request-money.index') ? 'btn-facebook':'btn-primary' }}" href="{{ route('user.request-money.index') }}"><i class="fas fa-arrow-alt-circle-up"></i> {{ __('Sent List') }}</a>
                            ...
                            <form action="{{ route('user.request-money.index') }}" class="card-header-form">
                                ...
                                <tbody>
                                    @foreach ($requests as $request)
                                        <tr>
                                            ...
                                            <td>
                                                {{ currency_format($request->amount, currency:user_currency()) }}
                                            </td>
