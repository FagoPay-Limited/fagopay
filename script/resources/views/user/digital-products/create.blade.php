...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Product digital create') }}</li>
@endsection

@section('actions')
    <a href="{{ route('user.digital-products.index', ['action' => 'products']) }}" class="btn btn-sm btn-neutral"><i class="fa fa-eye"
...
@section('content')
    <div class="row justify-content-center">
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.digital-products.store') }}" method="post" enctype="multipart/form-data" class="ajaxform_instant_reload">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-4 summernote-css">
                                ...
                                <textarea name="description" id="description" class="summernote" placeholder="{{ __("Product description") }}"></textarea>
                            </div>
                            <div class="col-sm-12 mb-4">
                                <label for="confirmation_message">{{ __("Confirm message") }}</label>
                                <textarea name="confirmation_message" id="confirmation_message" class="form-control" placeholder="{{ __("Confirmation message") }}"></textarea>
                            </div>
                        </div>
