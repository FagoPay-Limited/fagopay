...
@section('actions')
    ...
    <button type="button" class="btn btn-sm btn-neutral" data-toggle="modal" data-target="#send-moneyy">
...
@section('content')
    ...
    @push('modal')
        ...
        <div class="modal fade" id="send-moneyy" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="mb-0 h3 font-weight-bolder">@lang('Transfer money to') <span class="email"></span></h3>
